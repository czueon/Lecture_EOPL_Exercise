...
testcases = 
  [
    ...
    ("simple_add.let7_8", Just "33"),
    ("simple_mul.let7_8", Just "33"),
    ("simple_quo.let7_8", Just "4"),
    
    -- ex7_8 simple arith (with var)
    ("simple_add_var.let7_8", Just "5"),
    ("simple_mul_var.let7_8", Just "6"),
    ("simple_quo_var.let7_8", Just "3"),

    -- comparison
    ("test_equal.let7_8", Just "True"),
    ("test_equal_2.let7_8", Just "False"),
    ("test_greater.let7_8", Just "True"),
    ("test_greater_2.let7_8", Just "False"),
    ("test_less.let7_8", Just "True"),
    ("test_less_2.let7_8", Just "False")
  ]
